package com.kirinyt.app.util.extractors.ytdlp
...
import com.kirinyt.app.database.models.ChapterItem
...
import com.kirinyt.app.database.models.YoutubeGeneratePoTokenItem
import com.kirinyt.app.database.models.YoutubePlayerClientItem
import com.kirinyt.app.database.viewmodel.ResultViewModel
import com.kirinyt.app.util.BgUtilsPoTokenGeneratorUtil
import com.kirinyt.app.util.Extensions.getIDFromYoutubeURL
import com.kirinyt.app.util.Extensions.getIntByAny
import com.kirinyt.app.util.Extensions.getStringByAny
import com.kirinyt.app.util.Extensions.isSoundCloudURL
import com.kirinyt.app.util.Extensions.isURL
import com.kirinyt.app.util.Extensions.isYoutubeURL
import com.kirinyt.app.util.Extensions.isYoutubeWatchVideosURL
import com.kirinyt.app.util.Extensions.readJsonValue
        ...
        when(type){
            DownloadType.audio -> {
                ...
                if (audioQualityId.isBlank() || listOf("0", context.getString(R.string.best_quality), "ba", "best", "", context.getString(
                    ...
                    audioQualityId = "ba/b"
                }else if(audioQualityId.contains("kbps_kirinytgeneric")){
...
//                        }
            ...
            DownloadType.video -> {
                ...
                var abrSort = ""
                if(audioF.contains("kbps_kirinytgeneric")){
