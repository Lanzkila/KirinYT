package com.kirinyt.app.ui.more.settings.general
...
import com.kirinyt.app.databinding.NavOptionsItemBinding
import com.kirinyt.app.ui.adapter.IconsSheetAdapter
import com.kirinyt.app.ui.adapter.NavBarOptionsAdapter
import com.kirinyt.app.ui.more.settings.SettingHost
                ...
                (pref as SwitchPreferenceCompat).apply {
                    setOnPreferenceChangeListener { pref, _ ->
                        ...
                        val aliasComponentName =
                            ComponentName(context, "com.kirinyt.app.terminalShareAlias")
            ...
            "show_quick_download_share" -> {
                (pref as SwitchPreferenceCompat).apply {
                    setOnPreferenceChangeListener { pref, _ ->
                        val packageManager = context.packageManager
                        val aliasComponentName =
                            ComponentName(context, "com.kirinyt.app.quickDownloadShareAlias")
                        if ((pref as SwitchPreferenceCompat).isChecked){
                            packageManager.setComponentEnabledSetting(aliasComponentName,
                                PackageManager.COMPONENT_ENABLED_STATE_DISABLED,
                                PackageManager.DONT_KILL_APP)
